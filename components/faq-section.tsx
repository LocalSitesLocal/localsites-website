...
const faqs = [
  ...
  ['Was ist Care & Sichtbarkeit?', 'Monatliche Pflege für kleine Änderungen, technische Kontrolle, Google-/Bewertungsunterstützung und laufende Optimierung.'],
  ['Gibt es eine monatliche Betreuung?', 'Ja. Care & Sichtbarkeit startet bei ab 79 € pro Monat und kann kleine Änderungen, technische Kontrolle und Optimierung abdecken.'],

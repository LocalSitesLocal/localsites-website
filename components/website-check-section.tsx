      ...
      <div className="mx-auto max-w-7xl px-5 text-center sm:px-6 lg:px-8">
        <Reveal>
          <p className="mb-3 text-xs font-black uppercase tracking-[0.22em] text-[#0b63ce]">
            Kostenlose Website- und Anfrageanalyse
          </p>
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-[#52647d]">
            Sie erhalten innerhalb von 48-72 Stunden fünf konkrete Verbesserungsvorschläge zu mobiler
            Darstellung, Vertrauen, Kontaktwegen, lokaler Sichtbarkeit und Ihrem Anfrageprozess.
          </p>
